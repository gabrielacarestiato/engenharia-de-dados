...
spark.sql("COMMENT ON COLUMN premierleague.`posição` IS 'Player position'")
spark.sql("COMMENT ON COLUMN premierleague.`lesão` IS 'Type of injury'")
spark.sql("COMMENT ON COLUMN premierleague.`duração_dias` IS 'Injury duration in days'")
spark.sql("COMMENT ON COLUMN premierleague.nome IS 'Player name'")
spark.sql("COMMENT ON COLUMN premierleague.time IS 'Team name'")
spark.sql("COMMENT ON COLUMN premierleague.idade_anos IS 'Player age'")
spark.sql("COMMENT ON COLUMN premierleague.temporada IS 'Season of injury'")
spark.sql("COMMENT ON COLUMN premierleague.fifa IS 'Player FIFA rating at time of injury'")