...
spark.sql("COMMENT ON COLUMN premierleague.`posição` IS 'Posição do jogador. Valores possíveis: Goleiro, Defensor, Meio-campista, Atacante'")
spark.sql("COMMENT ON COLUMN premierleague.`lesão` IS 'Tipo de lesão. Valores possíveis: posterior da coxa, tornozelo, joelho, etc.'")
spark.sql("COMMENT ON COLUMN premierleague.`duração_dias` IS 'Duração da lesão em dias. Faixa esperada: 2-682'")
spark.sql("COMMENT ON COLUMN premierleague.nome IS 'Nome do jogador'")
spark.sql("COMMENT ON COLUMN premierleague.time IS 'Nome do time'")
spark.sql("COMMENT ON COLUMN premierleague.idade_anos IS 'Idade do jogador. Faixa esperada: 18-39'")
spark.sql("COMMENT ON COLUMN premierleague.temporada IS 'Temporada da lesão'")
spark.sql("COMMENT ON COLUMN premierleague.fifa IS 'Classificação FIFA do jogador no momento da lesão. Faixa esperada: 66-90'")